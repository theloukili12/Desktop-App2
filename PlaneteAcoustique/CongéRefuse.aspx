<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CongéRefuse.aspx.cs" Inherits="PlaneteAcoustique.CongéRefuse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="card shadow mb-4">
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Congé Refusé</h6>
...
where (year(Congées.DateCongé) = YEAR(getdate()))  and  (Employe.IdPersonne = @i) and (DemandeCongé.Reponse = 'Refusé')">
                      <SelectParameters>
