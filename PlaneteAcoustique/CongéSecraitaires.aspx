<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmi.Master" AutoEventWireup="true" CodeBehind="CongéSecraitaires.aspx.cs" Inherits="PlaneteAcoustique.CongéSecraitaires" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="card shadow mb-4">
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tous les Congées</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink"style="position: absolute; top: 0px; left: 0px; transform: translate3d(-156px, 19px, 0px);">
                      ...
                      <a class="dropdown-item" href="CongéIngenieures.aspx">Ingénieurs</a>
                      <a class="dropdown-item" href="Congétechicien.aspx">techniciens</a>
                      <a class="dropdown-item" href="CongéSecraitaires.aspx">Secrétaires</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="Tous_lescongées.aspx">Tous les Congés</a>
                    </div>
                  </div>
                </div>
<div class="card-body">
