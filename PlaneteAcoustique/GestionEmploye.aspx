<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmi.Master" AutoEventWireup="true" CodeBehind="GestionEmploye.aspx.cs" Inherits="PlaneteAcoustique.GestionEmploye" %>
...
<div class="card-body">
        ...
        CellPadding="4" ForeColor="#333333" GridLines="None"   Width="730px" HorizontalAlign="Left" 
               DataSourceID="SqlDataSource1" AllowSorting="True" PageSize="10">
              <Columns>
        ...
        <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TissyrePartnerConnectionString %>" SelectCommand="SELECT  Employe.Cin, Employe.Nom, Employe.Prenom, Employe.Telephone, Service.NomService FROM Employe INNER JOIN Service ON Employe.IdService = Service.IdService">
                  </asp:SqlDataSource>
</div>
</div>
</div>
