<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmi.Master" AutoEventWireup="true" CodeBehind="Gestiondesingenieurs.aspx.cs" Inherits="PlaneteAcoustique.Gestiondesingenieurs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="card shadow mb-4">
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Les Ingénieurs</h6>
...
<div class="card-body">
        ...
        <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TissyrePartnerConnectionString %>" SelectCommand="SELECT Employe.Cin, Employe.Nom, Employe.Prenom, Employe.Telephone, Service.NomService FROM Employe INNER JOIN Service ON Employe.IdService = Service.IdService WHERE (Service.NomService = N'Ingenieur') ORDER BY Employe.Nom">
                  </asp:SqlDataSource>
</div>
</div>
</div>
