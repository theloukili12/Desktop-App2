<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmi.Master" AutoEventWireup="true" CodeBehind="Settingsadmi.aspx.cs" Inherits="PlaneteAcoustique.Settingsadmi" %>
         ...
         font-weight:bold;
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
               <tbody>
                   ...
                   <tr>
                       <td class="parametre"><asp:CheckBox ID="checkpicture" runat="server" Text="Picture" /> </td>
                       <td>
